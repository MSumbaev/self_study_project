...
from quiz.views import MaterialQuizListAPIView, QuizQuestionsListAPIView, SubmitStudentAnswers, \
    ReportDetailAPIView
...
urlpatterns = [
    ...
    path('quiz/<int:quiz_id>/answers/', SubmitStudentAnswers.as_view(), name='post_answers'),
